...
[VolumeComponentMenu("Post-processing Custom/MechScreenEffect")]

// If the related Scriptable Renderer Feature doesn't exist, display a warning about adding it to the renderer.
[VolumeRequiresRendererFeatures(typeof(MechScreenEffectRendererFeature))]
...
[DisplayInfo(name = "MechScreenEffect")]

// Create the Volume Override by inheriting from VolumeComponent
public sealed class MechScreenEffectVolumeComponent : VolumeComponent, IPostProcessComponent
{
