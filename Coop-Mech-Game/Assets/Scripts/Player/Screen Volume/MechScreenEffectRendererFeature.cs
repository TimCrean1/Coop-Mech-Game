...
public sealed class MechScreenEffectRendererFeature : ScriptableRendererFeature
{
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        MechScreenEffectVolumeComponent myVolume = VolumeManager.instance.stack?.GetComponent<MechScreenEffectVolumeComponent>();
